...
import { obternerRegistroxID,ObtenerUsuario,sendPushNotification, addRegistro,setMensajeNotificacion } from '../../utils/Acciones'
import { size } from 'lodash'
import Loading from '../../Componentes/Loading'
import CarouselImages from '../../Componentes/CarouselImages'
import Carousel from "../../Componentes/Carousel";
import Modal from '../../Componentes/Modal'
import { enviarWhatsapp } from '../../utils/Uitl'
              ...
              <View>
                ...
                <View style={styles.boxinternoavatar}>
                  ...
                  <Icon
                    ...
                    size={40}
                    onPress={() => {
                      const mensajewhatsapp = `Estimado ${nombrevendedor}, mi nombre es ${usuarioactual.displayName}  me interesa el producto ${producto.titulo} que está en BUNKANNICHIBOKU`;
